(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,954126,e=>{"use strict";var t=e.i(481107),a=e.i(527076),r=e.i(965654),o=e.i(822558);let i=class e extends r.Shader{constructor(t){super(t={...e.defaultOptions,...t}),this.enabled=!0,this._state=o.State.for2d(),this.blendMode=t.blendMode,this.padding=t.padding,"boolean"==typeof t.antialias?this.antialias=t.antialias?"on":"off":this.antialias=t.antialias,this.resolution=t.resolution,this.blendRequired=t.blendRequired,this.clipToViewport=t.clipToViewport,this.addResource("uTexture",0,1),t.blendRequired&&this.addResource("uBackTexture",0,3)}apply(e,t,a,r){e.applyFilter(this,t,a,r)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(r){let o,i,{gpu:s,gl:f,...n}=r;return s&&(o=a.GpuProgram.from(s)),f&&(i=t.GlProgram.from(f)),new e({gpuProgram:o,glProgram:i,...n})}};i.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1,clipToViewport:!0},e.s(["Filter",0,i])},235066,790532,e=>{"use strict";let t={name:"local-uniform-bit",vertex:{header:`
        ...
        `}};e.s(["localUniformBit",0,t,"localUniformBitGl",0,r,"localUniformBitGroup2",0,a],235066);let o={name:"texture-bit",vertex:{header:`
    ...
    `}e.s(["uniformParsers",0,o],792715),e.s(["createUboSyncFunction",0,function(e,t,a,r){let i=[`
        var v = null;
        var v2 = null;
        var t = 0;
        var index = 0;
    ...
    `],s=0;for(let f=0;f<e.length;f++){let n=e[f],u=n.data.name,v=!1,l=0;for(let e=0;e<o.length;e++)if(o[e].test(n.data)){l=n.offset/4,i.push(`name = "${u}";`,`offset += ${l-s};`,o[e][t]||o[e].ubo),v=!0;break}if(!v)if(n.data.size>1)l=n.offset/4,i.push(a(n,l-s));else{let e=r[n.data.type];l=n.offset/4,i.push(`
        ...
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `};e.s(["uboSyncFunctionsSTD40",0,s,"uboSyncFunctionsWGSL",0,f],233156);var n=e.i(595932),u=e.i(124314);class v extends n.default{constructor({buffer:e,offset:t,size:a}){super(),this.uid=(0,u.uid)("buffer"),this._resourceType="bufferResource",this._touched=0,this._resourceId=(0,u.uid)("resource"),this._bufferResource=!0,this.destroyed=!1,this.buffer=e,this.offset=0|t,this.size=a,this.buffer.on("change",this.onBufferChange,this)}onBufferChange(){this._resourceId=(0,u.uid)("resource"),this.emit("change",this)}destroy(e=!1){this.destroyed=!0,e&&this.buffer.destroy(),this.emit("change",this),this.buffer=null,this.removeAllListeners()}}e.s(["BufferResource",0,v],287784)}]);