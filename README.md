...
**Live App:** https://Ripo2.github.io/skillproof/
...
- `contracts/SkillProof.py`: intelligent contract.
- [`CONTRACT_SPEC.md`](CONTRACT_SPEC.md): roles, topology, state machine, and
  negative test matrix.
- `src/components/proof-room.tsx`: evidence audition workspace.
- `src/components/proof-braid-canvas.tsx`: PixiJS braid renderer.
- `src/components/passport-explorer.tsx`: public credential reader.
- `src/lib/skillproof-client.ts`: typed 26-method integration.
- [`SECURITY.md`](SECURITY.md): evidence, wallet, and preview trust boundaries.
- [`DESIGN.md`](DESIGN.md): visual system and responsive behavior.
